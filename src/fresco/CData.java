...
public class CData {
	...
	/**`
	 * Fresco offers 6 possible views:
	 * <ul>
	 * <li> one of RGB color channels (in gray) - usefull in some kind of
	 * component analysis</li>
	 * <li>gray image - good for multimodal data</li>
	 * <li>mean - for segmented images</li>
	 * <li>original - elsewere</li>
	 * </ul>
	 * Current value is stored in static param <b>view</b>
	 */
	...
	/** Toolbar defines set of tools. @param tool holds id of this tool */
