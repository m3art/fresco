...
public class CMenuBar extends JMenuBar implements IFrescoComponent {
  ...
  /**
   * Constructor contains all necessary: listeners, menu items, ...
   */
  public CMenuBar() {
    super();
  ...
  private void createAnalysisMenu() {
     ...
     * MSER.addActionListener(CData.userActionListener); analysisMenu.add(MSER);
     */
  ...
  public void checkEnabled() {
    ...
    if (CData.showImage[0] != -1 && CData.showImage[2] != -1) {
      ...
      pointPairSelector.setEnabled(true);
      ...
      regQuality.setEnabled(false);
      pointPairSelector.setEnabled(false);
    }
