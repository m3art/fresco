...
public class CInterestingPoints extends CAnalysisWorker {
	 ...
	 */
	private final int GRID_CELL_WIDTH = 100;
	private final int GRID_CELL_HEIGHT = 100;
	...
	/**
	 * adds the best n points from a specified section of the image to the
	 * output
	 *
	...
	/**
	 * runs the whole thing, including the selection of points for matching i.
	 * e. runs the cornering algorithm chooses points according to "cornerity"
	 */
